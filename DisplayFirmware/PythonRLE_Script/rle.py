...
file_path = Path("./batteryData.txt")
...
lines = []
lines.append("const uint8_t batteryicon_rle[] = {")
...
lines.append("};")
lines.append(f"const size_t batteryicon_rle_len = sizeof(batteryicon_rle);")

# Save as .h file
header_path = Path("batteryData_rle.h")
