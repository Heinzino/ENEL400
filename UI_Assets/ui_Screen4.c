...
void ui_Screen4_screen_init(void)
{
    ...
    ui_YLabel1 = lv_label_create(ui_Screen4);
    lv_obj_set_width(ui_YLabel1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_YLabel1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_YLabel1, 192);
